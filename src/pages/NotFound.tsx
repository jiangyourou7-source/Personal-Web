  ...
  return (
    <div className="flex min-h-[60vh] items-center justify-center py-section-gap px-8">
      <div className="max-w-lg text-center">
        <p className="font-label-bold text-label-bold text-on-surface-variant uppercase tracking-[0.28em]">
          404
        </p>
        <h1 className="font-display-xl text-display-xl text-on-surface mt-6 font-bold">
          这个页面暂时没有找到
        </h1>
